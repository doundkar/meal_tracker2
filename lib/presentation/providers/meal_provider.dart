...
final mealRepositoryProvider =
    Provider((ref) => MealRepositoryImpl(ref.read(localDataSourceProvider)));

final addMealProvider =
    Provider((ref) => AddMeal(ref.read(mealRepositoryProvider)));

final getMealsProvider =
    Provider((ref) => GetMeals(ref.read(mealRepositoryProvider)));
